...
'''
import sys
sys.path.append("/home/murilo/C3DM/C3D/C3D-v1.0/python")
sys.path.remove('/home/aparecida/caffe/python')
print '\n'.join(sys.path)

#import imp
#caffe = imp.load_source('caffe', '/home/murilo/C3DM/C3D/C3D-v1.0/python/caffe/__init__.pyc')
...
def main():
    ...
    print 'Before create net'
    net = caffe.Net(model_def_file, model_file)
    print 'After create net'
    # caffe init
    gpu_id = 0
    ...
    test_video_list = '../c3d_finetuning/test_02.lst'
